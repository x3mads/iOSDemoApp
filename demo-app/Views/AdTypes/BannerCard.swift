...
struct BannerCard: View {
            ...
            VStack(alignment: .leading, spacing: Theme.Card.maximalSpacing) {
                VStack(alignment: .leading, spacing: Theme.Card.minimalSpacing) {
                    ...
                    TextField("Ad Space", text: $adSpace)
                        ...
                        .onSubmit {
                            adsStore.setAdSpace(adSpace, for: .banner)
                        }
                }
    ...
    private func showOrHide() {
        ...
        adsStore.setAdSpace(adSpace, for: .banner)
        XMediatorAds.banner.setAdSpace(adSpace, forPlacementId: placementId)
        let isReady = XMediatorAds.banner.isReady(withPlacementId: placementId)
